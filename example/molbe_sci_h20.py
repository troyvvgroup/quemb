...
# Using chemgen, h_treatment as treat_h_like_heavy_atoms will treat H atoms like heavy atoms,
# which works for hydrogen chains
add_args = ChemGenArgs(h_treatment="treat_h_like_heavy_atoms")
fobj = fragmentate(
    n_BE=2,
    mol=mol,
    frozen_core=False,
